...
{                                                     
    ...
    for (const auto& d : dumps)
    {
        ...
        DrawRectangle((int)dp.x - 12, (int)dp.y - 12, 24, 24,
RED);
    ...
    {
        Vector2 tp = worldToScreen(t.GetPosition());
        Color c;
        switch (t.GetState())
        {
        ...
        DrawTextEx(font, ("T" + std::to_string(t.GetId())).c_str(), {tp.x, tp.y - 25}, 16, 1, WHITE);
    }
